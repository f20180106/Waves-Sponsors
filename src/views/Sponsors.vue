	...
	<div class="header">
		...
		<v-layout row wrap justify-center align-center class="row">
				...
				<v-flex sm4 xs12>
					...
					>
						<v-card-title class="name">Yash Baranwal</v-card-title>
						<v-card-text class="email">yash.baranwal@bitswaves.org</v-card-text>
						<v-card-text class="mob-no">9967065804</v-card-text>
				...
				<v-flex sm4 xs12>
					...
					class="mx-auto contact-detail"
					>
						<v-card-title class="name">Siddak Bakshi</v-card-title>
						<v-card-text class="email">siddak@bitswaves.org</v-card-text>
						<v-card-text class="mob-no">9877370863</v-card-text>
						<v-card-actions class="buttons-row">
							<v-btn class="ma-2" text icon>
								<v-icon>mdi-facebook</v-icon>
							</v-btn>
      ...
      <div class="card">
        <div class="box box2">
          <img class="card-image-3"
            src="https://drive.google.com/file/d/1-_LCZF5yZEyPp-2As9tQ6QlrnFTGqqsv/view">
          <h2>Smart</h2>
